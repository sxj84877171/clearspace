...
- (void)socket:(GCDAsyncSocket *)sock didWriteDataWithTag:(long)tag
{
    ...
    /*add by jerry 2015-12-10*/
    if(dataSize != nil){
        [[NSNotificationCenter defaultCenter] postNotificationName:NTF_ID_FILE_DOWNLOAD_PARTIAL object:nil userInfo:@{@"filesize":dataSize}];
    }
