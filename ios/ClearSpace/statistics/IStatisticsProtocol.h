...
#ifndef IStatisticsProtocol_h
#define IStatisticsProtocol_h

#import <Foundation/Foundation.h>

@protocol IStatisticsProtocol <NSObject>
...
// record value event
- (void)    onEventValueCalcuate:(NSString*) eventId attributes:(NSDictionary*) attributes counter:(int)number
;

@end

#endif /* IStatisticsProtocol_h */
