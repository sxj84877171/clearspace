...
abstract class TokenRequest {
    ...
    public OAuthResponse execute() throws AuthException {
        ...
        mClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, CONNECT_TIMEOUT); 
        mClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, CONNECT_TIMEOUT);
