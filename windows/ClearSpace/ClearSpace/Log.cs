    ...
    public class Log : IDisposable
    {
        ...
        public void CleanLogFiles()
        {
            ...
            for (int i = 2; i < 17; i++)
            {
                ...
                now = DateTime.Now.AddDays(0 - i);
                try
                {
                    File.Delete(path + "UI_" + now.ToString(format));
                }
                catch
                {
        ...
        private string GetFilename()
        {
            ...
            return "UI_" + now.ToString(format);
        }
        ...
        private void FileOpen()
        {
            ...
            FileStream fs = new FileStream(path +  GetFilename(), FileMode.Append, FileAccess.Write, FileShare.Read);

           // writer = new StreamWriter(path + "UI_" + GetFilename(), true, Encoding.UTF8);
