...
; *** SetupLdr messages
SetupLdrStartupMessage=安装向导将安装 %1。 继续？
LdrCannotCreateTemp=无法创建临时文件。安装终止
LdrCannotExecTemp=无法运行临时文件。安装终止

; *** Startup error messages
LastErrorMessage=%1.%n%n错误 %2: %3
SetupFileMissing=安装目录中丢失文件%1。请重新弄一份程序拷贝。
SetupFileCorrupt=安装文件已被损坏。请重新弄一份程序拷贝。
SetupFileCorruptOrWrongVer=安装文件已被损坏，或与本安装向导版本不兼容。请解决该问题，或重新弄一份程序拷贝。
...
ErrorTooManyFilesInDir=由于文件夹“%1”中文件太多，无法在其中创建文件

; *** Setup common messages
ExitSetupTitle=退出安装向导
ExitSetupMessage=确定退出安装程序？
AboutSetupMenuItem=关于 inno setup Lesita qq316433938 汉化版(&A)…
AboutSetupTitle=关于 inno setup Lesita qq316433938 汉化版
AboutSetupMessage=%1版本%2%n%3%n%n%1主页：%n%4
AboutSetupNote=
TranslatorNote=翻译人：Lesita 联系方式：QQ：316433938
